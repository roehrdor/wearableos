...
public class Miscellaneous {
    ...
    static final int SIGN_IN__SUCCESSFUL_RESULT_CODE_1 = 1;
    static final int SIGN_IN__CANCELLED_RESULT_CODE_1 = 0;
    static final int SIGN_IN__SUCCESSFUL_RESULT_CODE_2 = -1;
